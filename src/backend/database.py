...
initial_announcements = [
    {
        "title": "Welcome Back!",
        "message": "Welcome to a new semester at Mergington High! Check out the new activities and clubs.",
        "start_date": None,
        "expiration_date": (datetime.datetime.utcnow() + datetime.timedelta(days=14)).isoformat(),
        "created_by": "admin",
